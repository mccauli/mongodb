...
defmodule Mongo.Monitor do
  ...
  defp check(state) do
    ...
    if diff < @min_heartbeat_frequency_ms do
      ...
      :ok = GenServer.cast(state.topology_pid, {:server_description, server_description}) # JF - fix from https://github.com/cristianberneanu/mongodb/commit/79e6c37edaec6c3d20cae75a673833106d5d5584
